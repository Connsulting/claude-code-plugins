...
The heuristic treats stderr, human-oriented stdout in interactive scripts, and structured error payloads returned for JSON CLIs as valid diagnostics when the output contract is consistent.
